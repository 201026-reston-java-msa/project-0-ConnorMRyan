...
public class Menu {
    ...
    void personalAccount() {
        ...
        if (customer.logIn()) {
            ...
            while (true) {
                printPersonalMenu();
                int numberAccounts = customer.getAccounts().size();
                switch (getChoice()) {
                    case 1:
                        if (numberAccounts > 0) {
                            withdraw(getAccount(customer), getAmount());
                        } else {
                            System.out.println("Sorry you have no accounts.");
                        }
                        break;
                    case 2:
                        if (numberAccounts > 0) {
            ...
            System.out.println("Sorry your login seems to have failed");
            quit();
        }
    }
            ...
            if (banker.isManager) {
                ...
                do {
                    ...
                    if (newBanker) {
                        ...
                        logger.trace("New banker was created");
                    }
                } while (newBanker);
                ...
                if (choice) {
                    ...
                    logger.trace("Bank Manager " + banker.getID() + " acted on " + customer.getID() + "'s accounts");
                    while (true) {
                        printPersonalMenu();
                        switch (getChoice()) {
                            case 1:
                    ...
                    do {
                        ...
                        switch (in.nextInt()) {
                            ...
                            case 3:
                                ...
                                break;
                            case 4:
                                banker.displayAccounts(banker.getAllAccounts());
                                break;
                            case 5:
                                quit();
                                break;
